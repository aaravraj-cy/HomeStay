...
<div class="dashboard-layout">
    ...
    <div class="dashboard-main animate__animated animate__fadeIn">
        ...
        <div class="row g-4">
                    ...
                    <div class="row g-3 mb-4 text-center">
                        <div class="col-6 col-sm-4">
                            <div class="bg-light p-2.5 rounded-3 border">
                                ...
                                <strong class="text-dark small"><i class="far fa-calendar-check text-teal me-1.5"></i><?= format_date($b['check_in']) ?></strong>
                            </div>
                        </div>
                        <div class="col-6 col-sm-4">
                            <div class="bg-light p-2.5 rounded-3 border">
                                <span class="text-muted d-block small mb-1">Check-out</span>
                                <strong class="text-dark small"><i class="far fa-calendar-xmark text-teal me-1.5"></i><?= format_date($b['check_out']) ?></strong>
                            </div>
                        </div>
                        <div class="col-12 col-sm-4">
                            <div class="bg-light p-2.5 rounded-3 border">
                                <span class="text-muted d-block small mb-1">Guest Occupants</span>
                                <strong class="text-dark small"><i class="fas fa-user-friends text-teal me-1.5"></i><?= (int)$b['guests'] ?> Guest<?= $b['guests'] > 1 ? 's' : '' ?></strong>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-5">
                <!-- Review Console -->
                <?php if (!$existingReview && in_array($b['status'], ['confirmed','completed'])): ?>
                <div class="dash-card border p-4 mb-4">
                    ...
                    <form method="POST">
                        ...
                        <button class="btn btn-teal btn-sm w-100 py-2 fw-bold"><i class="far fa-paper-plane me-1.5"></i> Submit Review</button>
                    </form>
                </div>
                ...
                <div class="dash-card border border-danger border-opacity-10 p-4 mb-4">
                    ...
                    <form method="POST" onsubmit="return confirm('Are you sure you want to cancel this booking?')">
                        ...
                        <button class="btn btn-outline-danger btn-sm w-100 py-2"><i class="fas fa-ban me-1.5"></i> Cancel Booking</button>
                    </form>
                </div>
                <?php endif; ?>
            </div>
