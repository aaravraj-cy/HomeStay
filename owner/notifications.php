        ...
        <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-4 pb-3 border-bottom">
            ...
            <div class="d-flex align-items-center gap-2">
                ...
                <form method="POST" class="d-inline">
                    ...
                    <button class="btn btn-sm btn-outline-teal fw-bold"><i class="fas fa-check-double me-1.5"></i>Mark all read</button>
                </form>
                
                <form method="POST" class="d-inline" onsubmit="return confirm('Clear all notification history? This cannot be undone.')">
                    <?= csrf_field() ?>
                    <input type="hidden" name="action" value="delete_all">
                    <button class="btn btn-sm btn-outline-danger fw-bold"><i class="far fa-trash-can me-1.5"></i>Clear History</button>
                </form>
                <?php endif; ?>
            </div>
        </div>
