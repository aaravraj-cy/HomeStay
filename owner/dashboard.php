...
$c4 = $conn->prepare("SELECT COALESCE(SUM(b.total_amount),0) FROM bookings b JOIN homestays h ON h.id=b.homestay_id
    ...
    WHERE h.owner_id=? AND b.status IN ('confirmed','completed')
...
<div class="dashboard-layout">
    ...
    <div class="dashboard-main animate__animated animate__fadeIn">
        ...
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 bg-light p-4 rounded-4 border mb-4 shadow-xs">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    ...
                    <p class="small text-muted mb-0">Manage your West Sikkim homestays and bookings in one dashboard.</p>
                </div>
            </div>
            <a href="<?= BASE_URL ?>owner/add-homestay.php" class="btn btn-teal btn-sm fw-bold px-3 py-2"><i class="fas fa-plus me-1.5"></i> Add New Homestay</a>
        </div>
            ...
            <div class="col-lg-4">
                ...
                <div class="dash-card border p-4 mb-4">
                    ...
                    <div class="d-flex flex-column gap-2">
                        <a href="<?= BASE_URL ?>owner/add-homestay.php" class="btn btn-light border text-start d-flex align-items-center justify-content-between p-2.5 rounded-3 text-dark small fw-semibold">
                            <span><i class="fas fa-circle-plus text-teal me-2"></i>Add Homestay</span>
                ...
                <div class="dash-card border p-4">
                    ...
                    <a href="mailto:support@sonamhomestay.local" class="btn btn-outline-teal btn-sm w-100 py-2 fw-bold"><i class="far fa-envelope me-1.5"></i>Contact Support</a>
                </div>
            </div>
        </div>
    </div>
