        ...
        <div class="dash-card border p-4 mb-4" style="max-width: 800px">
            ...
            <form method="POST" enctype="multipart/form-data" id="addHomestayForm">
                ...
                <div class="step-section" id="step1">
                    <div class="mb-3">
                        <label class="form-label small fw-bold text-muted text-uppercase mb-1"><i class="fas fa-heading text-teal me-1.5"></i>Homestay Title</label>
                    ...
                    <div class="mb-3">
                        <label class="form-label small fw-bold text-muted text-uppercase mb-1"><i class="fas fa-house-chimney text-teal me-1.5"></i>Property Type</label>
                        <select name="property_type" class="form-select fw-semibold">
                    ...
                    <div class="mb-4">
                        <label class="form-label small fw-bold text-muted text-uppercase mb-1"><i class="far fa-note-sticky text-teal me-1.5"></i>Description</label>
                ...
                <div class="step-section d-none" id="step2">
                    <div class="mb-3">
                        <label class="form-label small fw-bold text-muted text-uppercase mb-1"><i class="fas fa-location-dot text-teal me-1.5"></i>Street Address</label>
                ...
                <div class="step-section d-none" id="step3">
                    ...
                    <div class="mb-4">
                        <label class="form-label small fw-bold text-muted text-uppercase mb-1"><i class="far fa-image text-teal me-1.5"></i>Cover Image</label>
                    ...
                    <!-- House Rules -->
                    <div class="mb-4">
                        <label class="form-label small fw-bold text-muted text-uppercase mb-1"><i class="fas fa-circle-info text-teal me-1.5"></i>House Rules</label>
                        <textarea name="house_rules" class="form-control" rows="2" placeholder="e.g. No shoes inside, quiet hours after 10 PM..."></textarea>
                    </div>

                    <!-- Amenities Checklist -->
                    <div class="mb-4">
                        <label class="form-label small fw-bold text-muted text-uppercase mb-2"><i class="fas fa-square-check text-teal me-1.5"></i>Select Amenities</label>
                        <div class="row g-2">
