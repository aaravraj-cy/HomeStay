...
$reviews = $conn->prepare('SELECT r.*, h.title, u.full_name, u.profile_image FROM reviews r
        ...
        <div class="d-flex flex-column gap-3" style="max-width: 800px">
            ...
            <?php else: foreach ($reviews as $r): ?>
                <div class="dash-card border p-4">
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        <div class="d-flex align-items-center gap-2.5">
                            ...
                            <div>
                                ...
                                <span class="small text-muted" style="font-size: 0.75rem;">Reviewed <strong><?= e($r['title']) ?></strong> &middot; <?= time_elapsed($r['created_at']) ?></span>
                            </div>
                        </div>
                    ...
                    <?php endif; ?>
                    <p class="small text-muted mb-3" style="line-height: 1.5 bg-light p-3 rounded border">"<?= e($r['comment']) ?>"</p>
                    
                    <!-- Owner Reply Widget -->
                    <?php if ($r['owner_reply']): ?>
                        <div class="p-3 rounded-3 border bg-light bg-opacity-25" style="border-left: 3px solid var(--sn-teal) !important;">
                            <strong class="text-dark small d-block mb-1"><i class="fas fa-reply text-teal me-1.5"></i>Your Reply:</strong>
