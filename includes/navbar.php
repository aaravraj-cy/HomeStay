    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="mainNav">
            <ul class="navbar-nav mx-auto gap-lg-2">
                ...
                <li class="nav-item">
                    <a class="nav-link <?= $current === 'dashboard.php' ? 'active' : '' ?>" href="<?= BASE_URL ?>owner/dashboard.php">Dashboard</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?= $current === 'manage-homestays.php' ? 'active' : '' ?>" href="<?= BASE_URL ?>owner/manage-homestays.php">My Homestays</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?= $current === 'bookings.php' ? 'active' : '' ?>" href="<?= BASE_URL ?>owner/bookings.php">Bookings</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?= $current === 'earnings.php' ? 'active' : '' ?>" href="<?= BASE_URL ?>owner/earnings.php">Earnings</a>
                </li>
                <?php else: ?>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link <?= $current === 'search.php' ? 'active' : '' ?>" href="<?= BASE_URL ?>pages/search.php">Explore</a>
                </li>
                <li class="nav-item">
