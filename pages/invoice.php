...
<div class="container py-5">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 no-print animate__animated animate__fadeIn">
        <a href="<?= BASE_URL ?>user/booking-history.php" class="btn btn-light border btn-sm d-inline-flex align-items-center gap-1.5">
            <i class="fas fa-arrow-left"></i> Back to Trips
        </a>
        <button onclick="window.print()" class="btn btn-teal btn-sm d-inline-flex align-items-center gap-1.5">
